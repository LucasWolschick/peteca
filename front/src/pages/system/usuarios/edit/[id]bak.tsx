...
export default function Create() {
  ...
  //   if (file) {
  //     if (file.size <= 5242880) setImage(URL.createObjectURL(file));
  //     else {
            ...
            <div className="text-center d-flex flex-column align-items-center gap-2">
              ...
              {isAdmin && isNew && (
                <Dialog
                  ...
                  text="Deseja realmente invalidar a senha
deste usuário?"
                />
              )}
              {isAdmin && isNew && (
                <Dialog
                  ...
                  text="Deseja realmente descadastrar este
usuário?"
                />
              )}
            </div>
          ...
          <div className="col-md-12 mt-3 ">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-12 text-md-end text-center mt-auto">
                <button className="btn btn-primary btn-sm rounded-5 col-lg-12 col-md-6 col-8">
                  Salvar
                </button>
              </div>
            </div>
